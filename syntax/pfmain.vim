...
syntax keyword pfmainConf address_verify_pending_request_limit
...
syntax keyword pfmainConf default_transport_rate_delay
...
syntax keyword pfmainConf dns_ncache_ttl_fix_enable
...
syntax keyword pfmainConf lmtp_fallback_relay
...
syntax keyword pfmainConf milter_macro_defaults
...
syntax keyword pfmainConf openssl_path
...
syntax keyword pfmainConf postscreen_dnsbl_max_ttl
syntax keyword pfmainConf postscreen_dnsbl_min_ttl
...
syntax keyword pfmainConf smtp_tls_dane_insecure_mx_policy
...
syntax keyword pfmainConf smtpd_client_auth_rate_limit
...
syntax keyword pfmainConf smtpd_policy_service_policy_context
...
syntax keyword pfmainConf transport_transport_rate_delay
...
syntax match pfmainConf "_transport_rate_delay\>"
...
syntax match pfmainRef "$\<address_verify_pending_request_limit\>"
...
syntax match pfmainRef "$\<default_transport_rate_delay\>"
...
syntax match pfmainRef "$\<dns_ncache_ttl_fix_enable\>"
...
syntax match pfmainRef "$\<lmtp_fallback_relay\>"
...
syntax match pfmainRef "$\<milter_macro_defaults\>"
...
syntax match pfmainRef "$\<openssl_path\>"
...
syntax match pfmainRef "$\<postscreen_dnsbl_max_ttl\>"
syntax match pfmainRef "$\<postscreen_dnsbl_min_ttl\>"
...
syntax match pfmainRef "$\<smtp_tls_dane_insecure_mx_policy\>"
...
syntax match pfmainRef "$\<smtpd_client_auth_rate_limit\>"
...
syntax match pfmainRef "$\<smtpd_policy_service_policy_context\>"
...
syntax match pfmainRef "$\<transport_transport_rate_delay\>"
...
syntax keyword pfmainWord bounce
syntax keyword pfmainWord notify
syntax keyword pfmainWord noplaintext
syntax keyword pfmainWord noactive
syntax keyword pfmainWord nodictionary
syntax keyword pfmainWord noanonymous
...
syntax keyword pfmainWord 2bounce
syntax keyword pfmainWord data
syntax keyword pfmainWord delay
syntax keyword pfmainWord policy
syntax keyword pfmainWord protocol
syntax keyword pfmainWord resource
syntax keyword pfmainWord software
...
syntax keyword pfmainWord strict
syntax keyword pfmainWord never
syntax keyword pfmainWord res_defnames
syntax keyword pfmainWord res_dnsrch
...
syntax keyword pfmainWord delay_dotcrlf
syntax keyword pfmainWord disable_esmtp
syntax keyword pfmainWord mutual_auth
...
syntax keyword pfmainWord verify
...
syntax keyword pfmainWord forward_secrecy
